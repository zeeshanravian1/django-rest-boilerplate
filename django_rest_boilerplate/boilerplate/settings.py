...
DEBUG: bool = env.bool(var="DEBUG", default=True)  # type: ignore

ALLOWED_HOSTS: list[str] = env.list(
    var="ALLOWED_HOSTS",
    default=["localhost", "127.0.0.1"],  # type: ignore
)
...
ROOT_URLCONF: str = "boilerplate.urls"
...
WSGI_APPLICATION: str = "boilerplate.wsgi.application"
